...
class TestTemporalConvBlock:
    """Test suite for TemporalConvBlock."""
    ...
    def test_depthwise_vs_standard_convolution(self):
    ...
    def test_single_channel_no_depthwise(self):
    ...
    def test_different_dilations(self, dilation):
    ...
    def test_temporal_conv_block_properties(
        self, batch_size, seq_len, in_channels, out_channels, dilation
    ):
    ...
    def test_edge_case_very_short_sequence(self):
