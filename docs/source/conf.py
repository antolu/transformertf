...
import sps_mlp_hystcomp

if typing.TYPE_CHECKING:
    import sphinx.application


project = "sps-mlp-hysteresis-compensation"
author = "Anton Lu"
version = sps_mlp_hystcomp.__version__
...
def hijack_module_name_replacement() -> None:
    ...
    import sps_mlp_hystcomp._mod_replace

    for mod_name in list(sys.modules):
        if mod_name == "sps_mlp_hystcomp._mod_replace":
            continue
        if mod_name == "sps_mlp_hystcomp" or mod_name.startswith("sps_mlp_hystcomp."):
            del sys.modules[mod_name]

    sps_mlp_hystcomp._mod_replace.replace_modname = lambda *_: None  # noqa: SLF001
